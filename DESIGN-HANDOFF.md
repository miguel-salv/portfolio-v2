# e3b281dc-c5f8-4c77-a886-3b317e52f6b7 implementation handoff
...
## Entry points
- `index.html`
- `miguel-portfolio.html`
- `project-impedance.html`
- `project-kirby.html`
- `project-robot.html`
- `project-vehicle.html`
- `reference-site.html`
...
- `assets/logo-sata.png`
- `assets/metal-flower.png`
- `assets/portrait-work.png`
- `assets/project-impedance.png`
- `assets/project-kirby.png`
- `assets/project-robot.jpg`
- `assets/project-vehicle.png`
- `brand-spec.md`
- `critique.json`
- `mr3mv5jx-image.png`
- `mr3mzhto-image.png`
